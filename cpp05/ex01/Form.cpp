...
/*   Updated: 2023/01/10 10:44:34 by alalmazr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//  }
 ...
 std::ostream& operator<<(std::ostream& os, const Form& f) { 
     os << f.getName() << ", form status: " << (f.getIsSigned() ? "signed" : "unsigned") << ", required sign grade: " << f.getGradeToSign() << ", required execute grade: " << f.getGradeToExecute();  
